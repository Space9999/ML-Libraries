...
X = pca_import.PCA.transform(X, n_components = 10) # Reduce to 5 dimesions
...
mlp.fit(X_train, data_func.Data_Functions.to_categorical(y_train), epochs = 300, batch_size = 50)
